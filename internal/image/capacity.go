...
//
// Reading: FORMAT.md's "Profiles a reader must know" heading gives no
// numeric overhead budget, only the mkudffs options and the anchor
// placement rule. The probe-udf-small-files action measured
// close-to-one-sector-per-file
...
// docs/decisions.md under "Profiles a reader must know: filesystem
// overhead estimate".
